...
from app.routes import auth, plans, analytics, trip_sharing, trip_optimization, trips, trip_assistant
...
app.include_router(trip_assistant.router, prefix="/api/web")
